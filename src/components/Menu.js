        ...
        <div className="sidebar">
          <nav className="mt-2">
            ...
            >
             {
  Role == 1 ?
    <li className={`nav-item ${this.state.manageOpen ? 'menu-open' : ''}`}>
      <a href="#" className="nav-link" onClick={() => this.setState({ manageOpen: !this.state.manageOpen })}>
...
{
  Role == 1 || Role == 2 ?
    <li className={`nav-item ${this.state.serviceOpen ? 'menu-open' : ''}`}>
      <a href="#" className="nav-link" onClick={() => this.setState({ serviceOpen: !this.state.serviceOpen })}>
        <i className="fas fa-book mr-1" />
        <p>
          {t("service")}
          <i className="fas fa-angle-left right" />
...
{
  Role == 1 ?
    <li className={`nav-item ${this.state.reportOpen ? 'menu-open' : ''}`}>
      <a href="#" className="nav-link" onClick={() => this.setState({ reportOpen: !this.state.reportOpen })}>
        <i className="fas fa-book mr-1" />
        <p>
          {t("Report")}
          <i className="fas fa-angle-left right" />
