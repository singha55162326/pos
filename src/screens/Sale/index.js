                                                                ...
                                                                <div className="card-footer">
                                                                    <div className="text-center">
                                                                        {item.qty > 0 ?
                                                                            ...
                                                                            : <h6 className="text-danger">ນ້ຳມັນຫມົດແລ້ວ</h6>}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                {isDataBuy ?
                                                                    listDataBuy.map((item, i) => (
                                                                        <tr>
                                                                            ...
                                                                            <td>{formatNumber(item.price + "")}ກີບ</td>
                                                                            <td>{formatNumber(item.total + "")}ກີບ</td>
                                                                    ...
                                                                    <div className="table-responsive">
                                                                        <table className="table">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <th>{t('Total')}</th>
                                                                                    <td>{formatNumber(listDataBuy.reduce((a, v) => a = a + v.total, 0) + "")}ກີບ</td>
                                                                                </tr>
                                                                            </tbody></table>
                                                                    </div>
